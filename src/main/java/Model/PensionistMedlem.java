...
public class PensionistMedlem extends Members {
    ...
    public PensionistMedlem(int unicID, String name, String email, int tlfNr, LocalDate fodselsdag, String favSvommeArt, String svommeHold,double kontingent, boolean restance) {
        super(unicID, name, email, tlfNr, fodselsdag, favSvommeArt, svommeHold,kontingent,restance);
    }

    @Override
    public double kontigentBeregner() {
        double kontingent = 1800;
